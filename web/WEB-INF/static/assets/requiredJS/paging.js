...
$.fn.paging = function(param) {
    ...
    init(); //绘制页码
    pagingParam._thisUl.children('li:eq(' + (pagingParam.initPage + 1) + ')').addClass('active'); //设置选中页码
    ...
    /*绘制页码函数*/
    function init() {
        var headPage = $('<li>'),prevPage=$('<li>'),endPage = $('<li>'),nextPage=$('<li>');
        $('<a href="javascript:;">').text('首页').appendTo(headPage); /*首页*/
        headPage.appendTo(pagingParam._thisUl);
        $('<a href="javascript:;">').text('上一页').css(pagingParam.liCss).appendTo(prevPage); /*上一页*/
        prevPage.appendTo(pagingParam._thisUl);
        ...
        for (var i = pagingParam.nowShowMin; i <= pagingParam.nowShowMax; i++) { /*遍历产生页码*/
            ...
            $('<a href="javascript:;">').text(i).css(pagingParam.liCss).appendTo(newLi);
            newLi.appendTo(pagingParam._thisUl);
        ...
        $('<a href="javascript:;">').text('下一页').css(pagingParam.liCss).appendTo(nextPage); /*下一页*/
        $('<a href="javascript:;">').text('尾页').css(pagingParam.liCss).appendTo(endPage); /*尾页*/
        nextPage.appendTo(pagingParam._thisUl);
        endPage.appendTo(pagingParam._thisUl);
    ...
    function nextPageCount() {
        ...
        init();
        pagingParam._thisUl.children('li:eq(' + (pagingParam.nowIndex - pagingParam.nowShowMin + 2) + ')').addClass('active').siblings('li').removeClass('active');
